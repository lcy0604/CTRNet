...
def TResnetM(): #model_params
    ...
    model = TResNet(layers=[3, 4, 11, 3], in_chans=in_chans)
    return model
...
def TResnetL(): #model_params
    ...
    model = TResNet(layers=[4, 5, 18, 3], in_chans=in_chans, width_factor=1.2)
    return model
...
def TResnetXL(): #model_params
    ...
    in_chans = 3
    # num_classes = model_params['num_classes']
    model = TResNet(layers=[4, 5, 24, 3], in_chans=in_chans, width_factor=1.3)
